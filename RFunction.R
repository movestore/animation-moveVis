...
rFunction <- function(data,reso,uni,maptype="watercolor")
{
  Sys.setenv(tz="UTC")
  ...
  frames <- frames_spatial(m, path_colours=tim.colors(n.indiv(data)), map_service = "osm", map_type = maptype, alpha = 0.5) %>%
